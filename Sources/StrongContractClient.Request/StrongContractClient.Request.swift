...
// Conversion examples integrated with request structures
extension StrongContractClient.Request where Payload == UpdateScheduleRequest, Response == StandardPostResponse {
    public static var updateSchedule: Request {
        Request(path: "updateSchedule", method: .post)
    }
}

extension StrongContractClient.Request where Payload == UpdateGreetRequest, Response == StandardPostResponse {
    public static var updateGreet: Request {
        Request(path: "updateGreet", method: .post)
    }
}

extension StrongContractClient.Request where Payload == UpdateGreetSettingsRequest, Response == StandardPostResponse {
...
// Conversion examples integrated with request structures
extension StrongContractClient.Request where Payload == UpdateUserLocationRequest, Response == StandardPostResponse {
...
extension StrongContractClient.Request where Payload == SilentPushLocationUpdatesRequest, Response == StandardPostResponse {
